...
public class MessageConst {
    public static final String INPUT_NAME_MSG = "경주 할 자동차 이름을 입력하세요.(이름은 쉼표(,) 기준으로 구분)";
    public static final String INPUT_TRYTIMES_MSG = "시도할 회수는 몇회인가요?";
    ...
    public static final String NAME_NULL_EXCEPTION_MSG = "[ERROR] - 이름을 입력해주십시오.";
}
